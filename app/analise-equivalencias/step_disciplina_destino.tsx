...
import { disciplinaDestino } from "@/types/geral";
...
const StepDisciplinaDestino = ({ disciplinaDestino, setDisciplinaDestino }: { disciplinaDestino: disciplinaDestino, setDisciplinaDestino: any}) => {
    ...
    const handleFaculdadeChange = (e: number) => {
        setDisciplinaDestino((prevDisciplinaDestino: any) => ({
          ...prevDisciplinaDestino,
          faculdade: e,
        }));
      };
    ...
    useEffect(() => {
        ...
        if (disciplinaDestino.faculdade) {
            setFaculdadeSelecionada(disciplinaDestino.faculdade);
        }
        if (disciplinaDestino.curso) {
            setCursoSelecionado(disciplinaDestino.curso);
        }
        if (disciplinaDestino.disciplina) {
            setDisciplinaSelecionado(disciplinaDestino.disciplina);
        }
        ...
        <>
            ...
            <div className="flex flex-col gap-4 mt-4">
                <span className="text-default-400 text-small">
                    Selecione a disciplina que o aluno deseja eliminar
                </span>
...
export default StepDisciplinaDestino;